...
| Official CommonMark conformance | **Implemented (ratcheted floor)** | `commonmark-conformance.sh ci` — 370/652 spec examples (370/591 in-scope, 62.6%), pass count at the enforced floor of 370 |
...
(pass 370/652 ≥ floor 370) · `cargo test --features batch` (7) + batch clippy ·
