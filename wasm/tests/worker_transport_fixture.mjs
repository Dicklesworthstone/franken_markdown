...
serveOwnedWorker(endpoint, async (method, args) => {
  ...
  switch (method) {
    ...
    case "bytes":
      ...
      break;
    case "knownError":
      throw new FlowWorkerError("STALE_REVISION", "synthetic revision conflict");
    case "crash":
      setTimeout(() => {
      ...
      break;
    case "badReply":
      parentPort.postMessage({ protocol: WORKER_PROTOCOL, id: 999, ok: true });
      await sleep(10000);
      break;
    case "badValue":
      value = () => {};
      break;
    case "untypedError":
      throw new Error("synthetic unknown operation failure");
    default:
      throw new FlowWorkerError("UNKNOWN_METHOD", "synthetic method is not supported");
  }
