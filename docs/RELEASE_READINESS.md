...
| Official CommonMark conformance | **Implemented (ratcheted floor)** | `commonmark-conformance.sh ci` — 362/652 spec examples (362/591 in-scope, 61.3%), pass count at the enforced floor of 362 |
...
(pass 362/652 ≥ floor 362) · `cargo test --features batch` (7) + batch clippy ·
