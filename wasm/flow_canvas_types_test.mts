...
import { FlowCanvasRenderer, type CanvasFlowSession } from "@franken-suite/franken-markdown/flow-canvas";
...
const paint = new FlowCanvasRenderer(new OffscreenCanvas(1, 1), { limits: { maxCachedGlyphs: 100 } });
...
paint.dispose(); worker.dispose(); sync.dispose();
