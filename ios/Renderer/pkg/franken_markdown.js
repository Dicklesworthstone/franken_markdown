...
export function renderBookPdf(
  ...
  try {
    ...
    var ptr2 = isLikeNone(title)
      ? 0
      : passStringToWasm0(title, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(author)
      ? 0
      : passStringToWasm0(author, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(font)
      ? 0
      : passStringToWasm0(font, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    var ptr5 = isLikeNone(dark_mode)
      ? 0
      : passStringToWasm0(dark_mode, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    ...
    wasm.renderBookPdf(
      ...
      ptr5,
      len5,
      !isLikeNone(font_scale),
      isLikeNone(font_scale) ? 0 : font_scale,
      page_numbers,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
export function renderBookSite(paths, sources, title, font, dark_mode, font_scale) {
  try {
    ...
    var ptr2 = isLikeNone(title)
      ...
      : passStringToWasm0(title, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(font)
      ? 0
      : passStringToWasm0(font, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(dark_mode)
      ? 0
      : passStringToWasm0(dark_mode, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    wasm.renderBookSite(
...
export function renderEpubConfigured(markdown, font, dark_mode, title, lang, font_scale) {
  try {
    ...
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(font)
      ? 0
      : passStringToWasm0(font, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(dark_mode)
      ? 0
      : passStringToWasm0(dark_mode, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(title)
      ? 0
      : passStringToWasm0(title, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(lang)
      ? 0
      : passStringToWasm0(lang, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    wasm.renderEpubConfigured(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderHtmlConfigured(markdown, font, dark_mode, title, custom_css, allow_raw_html) {
  try {
    ...
    var ptr3 = isLikeNone(title)
      ...
      : passStringToWasm0(title, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(custom_css)
      ? 0
      : passStringToWasm0(custom_css, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    wasm.renderHtmlConfigured(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderHtmlConfiguredAdvanced(
  ...
  try {
    ...
    var ptr14 = isLikeNone(lang)
      ? 0
      : passStringToWasm0(lang, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len14 = WASM_VECTOR_LEN;
    wasm.renderHtmlConfiguredAdvanced(
      retptr,
      ptr0,
      len0,
      ptr1,
      ...
      len14,
      toc,
      isLikeNone(toc_depth) ? Number.MAX_SAFE_INTEGER : toc_depth >>> 0,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
export function renderHtmlConfiguredMulti(
  ...
  try {
    ...
    const ptr13 = passArray32ToWasm0(image_bytes_lengths, wasm.__wbindgen_export);
    const len13 = WASM_VECTOR_LEN;
    wasm.renderHtmlConfiguredMulti(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderHtmlConfiguredWithFonts(
  ...
  try {
    ...
    const ptr10 = passArray32ToWasm0(font_weights, wasm.__wbindgen_export);
    const len10 = WASM_VECTOR_LEN;
    wasm.renderHtmlConfiguredWithFonts(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderInteractiveHtmlConfigured(
  ...
  try {
    ...
    var ptr4 = isLikeNone(lang)
      ...
      : passStringToWasm0(lang, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    wasm.renderInteractiveHtmlConfigured(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderPdfConfigured(
  ...
  try {
    ...
    var ptr3 = isLikeNone(title)
      ...
      : passStringToWasm0(title, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len3 = WASM_VECTOR_LEN;
    var ptr4 = isLikeNone(author)
      ? 0
      : passStringToWasm0(author, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    var len4 = WASM_VECTOR_LEN;
    wasm.renderPdfConfigured(
      retptr,
      ptr0,
      len0,
      ptr1,
      ...
      ptr4,
      len4,
      !isLikeNone(metadata_epoch_seconds),
      isLikeNone(metadata_epoch_seconds) ? 0 : metadata_epoch_seconds,
      allow_raw_html,
      code_line_numbers,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
...
export function renderPdfConfiguredMulti(
  ...
  try {
    ...
    wasm.renderPdfConfiguredMulti(
      ...
      ptr13,
      len13,
      !isLikeNone(base_font_size),
      isLikeNone(base_font_size) ? 0 : base_font_size,
      !isLikeNone(heading_scale),
      isLikeNone(heading_scale) ? 0 : heading_scale,
      !isLikeNone(table_font_size),
      isLikeNone(table_font_size) ? 0 : table_font_size,
      page_numbers,
      !isLikeNone(font_scale),
      isLikeNone(font_scale) ? 0 : font_scale,
      ptr14,
      ...
      toc,
      isLikeNone(toc_depth) ? Number.MAX_SAFE_INTEGER : toc_depth >>> 0,
      isLikeNone(fit_to_pages) ? Number.MAX_SAFE_INTEGER : fit_to_pages >>> 0,
      microtype_protrusion,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
export function renderPdfConfiguredWithAssets(
  ...
  try {
    ...
    const len11 = WASM_VECTOR_LEN;
    wasm.renderPdfConfiguredWithAssets(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderPdfConfiguredWithImage(
  ...
  try {
    ...
    const ptr6 = passArray8ToWasm0(image_bytes, wasm.__wbindgen_export);
    const len6 = WASM_VECTOR_LEN;
    wasm.renderPdfConfiguredWithImage(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function renderSemanticDiffHtml(old_markdown, new_markdown, old_name, new_name) {
  ...
  const len1 = WASM_VECTOR_LEN;
  var ptr2 = isLikeNone(old_name)
    ? 0
    : passStringToWasm0(old_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
  var len2 = WASM_VECTOR_LEN;
  var ptr3 = isLikeNone(new_name)
    ? 0
    : passStringToWasm0(new_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
  var len3 = WASM_VECTOR_LEN;
...
export function renderSvgConfigured(markdown, font, dark_mode, font_scale, max_width_pt) {
  try {
    ...
    wasm.renderSvgConfigured(
      ...
      !isLikeNone(font_scale),
      isLikeNone(font_scale) ? 0 : font_scale,
      !isLikeNone(max_width_pt),
      isLikeNone(max_width_pt) ? 0 : max_width_pt,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
const FmdRenderResultFinalization =
