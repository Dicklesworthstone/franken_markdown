...
| Official CommonMark conformance | **Implemented (ratcheted floor)** | `commonmark-conformance.sh ci` — 363/652 spec examples (363/591 in-scope, 61.4%), pass count at the enforced floor of 363 |
...
(pass 363/652 ≥ floor 363) · `cargo test --features batch` (7) + batch clippy ·
