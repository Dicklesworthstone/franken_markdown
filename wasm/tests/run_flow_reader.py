...
sources = {name: (root / name).read_text() for name in [
    "flow_reading.mjs", "flow-reader.js", "tests/flow_reading_fixtures.mjs", "tests/flow_reader.browser.mjs"
]}
with sync_playwright() as playwright:
    ...
    try:
        ...
        page.set_content("<!doctype html><title>Flow reader tests</title>")
