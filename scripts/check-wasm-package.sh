...
for file in book.js book.d.ts book_session.mjs book-worker.js book-worker.d.ts book_worker.mjs book_worker_entry.js BOOK.md flow.js flow.d.ts flow_session.mjs flow_outlines.mjs flow-canvas.js flow-canvas.d.ts CANVAS.md FLOW.md \
...
for file in book.html book.js book_collection.mjs book_controls.mjs flow-source.js flow_document.mjs flow_draft_store.mjs flow_draft_session.mjs flow_draft_controls.mjs; do
