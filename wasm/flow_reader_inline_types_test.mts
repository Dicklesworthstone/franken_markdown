...
import type { FlowReadingInlineEntry, FlowReadingLinkActivation, ReadingFlowSession } from "./flow-reader.js";
import type { FlowReadingInlineRun, FlowReadingNode } from "./flow.js";
declare const element: HTMLElement;
declare const session: ReadingFlowSession;
const reader = new FlowReaderView(element, { onLink(activation) {
...
const snapshot = await readFlowDocument(session, { limits: { maxInlineRuns: 200, maxLinkUnits: 2000 } });
...
const legacy: FlowReadingNode = { role: "paragraph", text: "plain", children: [],
